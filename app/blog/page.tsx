...
export default function BlogPage() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Recap of our recent team building workshop and the skills we developed.",
    ...
    {
      id: 5,
      title: "Programming Challenges: Autonomous Navigation",
      excerpt: "Our programming team shares insights on developing autonomous navigation for this season.",
    ...
    {
      id: 6,
      title: "Community Outreach: STEM Workshop for Middle Schools",
      excerpt: "Team Centaurus hosted a robotics workshop for local middle school students.",
